...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'HakAkses:admin']], function () {
    ...
    Route::post('/fitur/delete', [FiturController::class, 'deletefitur'])->name('delete.fitur');
    ...
    Route::post('/kontak/delete', [KontakController::class, 'deletekontak'])->name('delete.kontak');
