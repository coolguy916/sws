<!-- Modal -->
<div class="modal fade" id="updatetesti" tabindex="-1" aria-labelledby="addModalLabel" aria-hidden="true">
    <form action="" method="POST" id="updatetestimoni">
        @csrf
...
<div class="mb-3">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary update_testi">Save Kontak Website</button>
                    </div>
                </div>
            </div>
    </form>
