...
class CreateWattsConsumptionsScheduledTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('watts_consumptions_realtime', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('watts_consumptions_realtime');
    }
}
