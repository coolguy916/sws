...
class CreateWattsConsumptionsDailyTable extends Migration
{
       /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('watts_consumptions_daily', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('watts_consumptions_daily');
    }
}
